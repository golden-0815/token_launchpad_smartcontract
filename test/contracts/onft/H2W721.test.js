...
describe("H2W721: ", function () {
    ...
    before(async function () {
        ...
        ONFT = await ethers.getContractFactory("H2W721")
    ...
    it("sendFrom() - mint on the source chain and send ONFT to the destination chain", async function () {
        ...
        await ONFTSrc.mint({value: ethers.utils.parseEther("0.0004")});
        ...
        await expect(ONFTSrc.mint({value: ethers.utils.parseEther("0.0004")})).to.revertedWith("Too many, bruv")
    })
})
